...
Route::group([ 'middleware' => ['auth']], function() {
    ...
    Route::resource('activity', 'ActivityController', ['only'  => [
        'index',
    ]]);
    Route::get('lesson-list', ['as' => 'list', 'uses' => 'LessonController@index']);
    Route::get('learning-lesson', ['as' => 'word.startLearning', 'uses' => 'WordController@index']);
    Route::get('learning-word-{id}', ['as' => 'word.learning', 'uses' => 'WordController@show']);
